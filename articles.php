    ...
    <div class="container contenu mb-4">  
        <div class="row">  
            <div class="col-md-10 offset-md-1 p-0">
                <h2 class="py-4 text-center">Article 1</h2>            
                <a href="#"><img class="justify-content-center w-100" src="./assets/img/campus-des-mureaux.jpg"></a>
        ...
        <div class="row">  
            <div class="col-md-10 offset-md-1 p-0">
                <h2 class="py-4 text-center">Article 2</h2>            
                <a href="#"><img class="justify-content-center w-100" src="./assets/img/campus_06.jpg"></a>
        ...
        <div class="row">  
            <div class="col-md-10 offset-md-1 p-0">
                <h2 class="py-4 text-center">Article 3</h2>            
                <a href="#"><img class="justify-content-center w-100" src="./assets/img/campus-des-mureaux.jpg"></a>
        ...
        <div class="row">  
            <div class="col-md-10 offset-md-1 p-0">
                <h2 class="py-4 text-center">Article 4</h2>            
                <a href="#"><img class="justify-content-center w-100" src="./assets/img/campus_06.jpg"></a>
